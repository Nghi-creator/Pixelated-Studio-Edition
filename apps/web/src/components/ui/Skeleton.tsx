  ...
  return (
    <div className="w-full">
      <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <Skeleton className="h-8 w-36 border-l-4 border-synth-border" />
...
export function AdminTableSkeleton({
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-synth-border bg-synth-surface shadow-card">
      <div
...
export function ModerationQueueSkeleton() {
  return (
    <div className="space-y-8">
      ...
      <section className="rounded-xl border border-synth-border bg-synth-surface p-6 shadow-card">
...
export function ProfileSkeleton() {
  return (
    <div className="mx-auto mt-8 w-full max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="space-y-8">
        <section className="rounded-2xl border border-synth-border bg-synth-surface p-6 shadow-card md:p-8">
