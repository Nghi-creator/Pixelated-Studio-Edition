...
Documents not listed as current are historical plans or supporting evidence and
...
- `backend-hosting-checklist.md`
- `lan-manual-smoke-checklist.md`
- `docker-onboarding-validation.md`
